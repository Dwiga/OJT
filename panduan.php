  ...
  <div class="page-content"><!--page-->
   <div class="row"><!--row-->    
    <div class="col-md-7"><!-- bagian tulisan-->            
     <h4 class="popover-title"><strong><span>Panduan MT4</span></strong></h4>
     	<p>form panduan pengguna ini memungkinkan anda untuk mendownload dan mereview kembali dokumen yang relevan</p>
        <table style="width: 100%;" cellpadding="2" cellspacing="2">
        <tbody>
        <tr>
        <td><strong>MT4 Desktop Client User Guide </strong>
        <p style="width: 100px; margin: 0px auto;"><a class="button" href="http://www.mpf.co/download/tutorial/MT4_User_Guide.pdf" target="_blank">Download</a></p>
        </td>
        <td><strong>MT4 BlackBerry Client User Guide</strong>
        <p style="width: 100px; margin: 0px auto;"><a class="button" href="http://www.mpf.co.id/download/tutorial/Millennium%20Trader%204%20Blackberry%20Manual%20Guide.pdf" target="_blank">Download</a></p>
        </td>
        </tr>
        <tr>
        <td><strong>ET5 Desktop Client User Guide</strong>
        <p style="width: 100px; margin: 0px auto;"><a class="button" href="http://www.mpf.co.id/download/tutorial/ET5_User_Guide_270212.pdf" target="_blank">Download</a></p>
        </td>
        <td></td>
        </tr>
        </tbody>
