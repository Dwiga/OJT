    ...
    <li>
      <a class="active">Kebijakan Trading</a>
    	<ul class="dropdown">
	     ...
	     <li><a class="active" href="pembatalan.php">Pembatalan Perdagangan</a></li> 
  ...
  <div class="page-content"><!--page-->
   <div class="row"><!--row-->    
    <div class="col-md-7"><!-- bagian tulisan-->            
     <h4 class="popover-title"><strong><span>Pembatalan perdagangan </span></strong></h4>
     	<div class="panel-body">Posisi Klien dapat dibatalkan untuk berikut (namun tidak terbatas pada hal ini), alasan:
        <?php
		$baris=0;
