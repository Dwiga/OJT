...
<head>
    ...
    <!-- Basic -->
    <title>Victory | Call Me Back</title>
...
if ((!empty($_POST['tanggal'])) && (!empty($_POST['alamat'])) && (!empty($_POST['telp'])) && (!empty($_POST['nama'])) && (!empty($_POST['jam'])) && (!empty($_POST['kota']))){
// Simpan Data
$sql = "INSERT INTO cmb (tanggal,alamat,telp,nama,jam,kota) VALUES ('".$_POST['tanggal']."','".$_POST['alamat']."','".$_POST['telp']."','".$_POST['nama']."','".$_POST['jam']."','".$_POST['kota']."')";
...
echo "<script>alert('Input Masih ada yang Kosong'); history-go(-1);</script>";
    ...
    <div class="controls">
    <input type="text" placeholder="Hubungi saya pada tanggal" name="tanggal">
    </div>
    </div>
        <div class="form-group">
    <div class="controls">
    ...
    <button type="submit" id="simpan" name="simpan" class="btn-system btn-large">Kirim</button><div id="success" style="color:#34495e;"></div>
