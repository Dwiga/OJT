...
<div id="content"><!--profil-->
 <div class="container"><!-- container profil-->
  <div class="page-content"><!--page-->
   <div class="row"><!--row-->    
    <div class="col-md-12"><!-- bagian tulisan-->            
     <h4 class="popover-title"><strong><span>Fundamental</span></strong></h4>
     <p><strong><font size="+1">Dow Jones dan S&P500 cetak rekor New High </font></strong></p>
     	<p>Selama sesi perdagangan rabu, Dow menyentuh intraday tertinggi sepanjang masa pada 15,301.34, sementara indeks S & P 500 mencapai puncak rekor intraday di 1,661.49. Sebelumnya, Nasdaq telah mencapai tertinggi selama 52-minggu di 3,475.48.

Kenaikan Dow dibatasi oleh kelemahan dalam Intel Corp (INTC.O), turun 1 persen pada $ 23,84, dan UnitedHealth Group (UNH.N), turun 1,1 persen pada $ 61,73.

Sembilan dari sepuluh top gainer S & P 500 mengalami kenaikan pada sesi perdagangan rabu, di antaranya adalah indeks sektor konsumen SPLRCS, naik 1 persen, dan sektor keuangan SPSY, juga naik 1 persen. Satu-satunya yang mengalami penurunan adalah indeks sektor energi SPNY, yang turun 0,4 persen.

Volume perdagangan sekitar 6,2 miliar saham di New York Stock Exchange, Nasdaq dan NYSE MKT, tepat di bawah volume penutupan rata-rata harian sekitar 6,4 miliar tahun ini.</p>

     <p><strong><font size="+1">Pesimisme Data Lemahkan Saham-saham Hong Kong </font></strong></p>
     	<p>Bursa Hong Kong turun pada sesi perdagangan hari Senin setelah data yang dirilis Jumat menunjukkan pinjaman bank China melambat pada bulan April dibandingkan bulan sebelumnya.

Indeks Hang Seng HSI turun 0,7% menjadi 23,167.16</p>
