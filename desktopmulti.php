...
<!-- navigation list -->
   <div class="navbar-collapse collapse">
    ...
    <li>
	  <a class="active">Download Metatrader</a>
    	<ul class="dropdown">
		 <li><a href="desktopterminal.php">Dekstop Terminal</a></li>
	     <li><a class="active" href="desktopmulti.php">Dekstop Multiterminal</a></li> 
  ...
  <div class="page-content"><!--page-->
   <div class="row"><!--row-->    
    <div class="col-md-7"><!-- bagian tulisan-->            
     <h4 class="popover-title"><strong><span>MT4 MULTITERMINAL</span></strong></h4>
     <p style="width: 100px; margin: 0px auto;"><a class="button" href="<?php echo $link->desmul ?>" target="_blank">Download</a></p>
     <p><?php echo $ketlink->desmul ?></p>
