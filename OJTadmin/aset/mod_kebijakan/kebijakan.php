	  ...
	  <div class="row">
		  <div class="col-md-12">
			  <div class="panel panel-default">
				  <div class="panel-heading"><a href="?go=home"><button class="btn btn-labeled btn-default"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</button></a> <h4 style="float:right;margin:0px 5px 5px 0px">Kebijakan</h4></div>
