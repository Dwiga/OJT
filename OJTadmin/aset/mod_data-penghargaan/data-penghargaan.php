			...
			<div class="col-md-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
                    	<a class="btn btn-primary" title="Tambah Penghargaan" style="margin-bottom:5px" data-toggle="modal" data-target="#myModal" href="<?php echo $self ?>&aksi=form&opsi=tambah"><i class="glyphicon glyphicon-pencil"></i>&nbsp;&nbsp;&nbsp;Tambah Penghargaan</a>
