    ...
    <ul class="nav navbar-nav navbar-right">
     <li>
       <a  class="active" href="index.php">Beranda</a>
    	<ul class="dropdown">
		 <li><a class="active" href="legalitas.php">Legalitas Broker</a></li>
  ...
  <div class="page-content"><!--page-->
   <div class="row"><!--row-->    
    <div class="col-md-12"><!-- bagian tulisan-->            
     <h4 class="classic-title"><span>Legalitas Broker</span></h4>
<?php
		$baris=0;
		foreach($legalitas as $kolom)
		{
	?>
              <div id="<?php echo $baris ?>">
              <a><strong><?php echo $kolom->nama ?></strong></a>
              
     <strong><p><?php echo $kolom->nomor ?></p></strong>
     	<p><?php echo $kolom->legalitas ?></p></div>
   <?php
		$baris++;
		}
    ?>
