    ...
    <li>
      <a class="active">Kebijakan Trading</a>
    	<ul class="dropdown">
         ...
         <li><a class="active" href="komisi.php">Komisi dan biaya</a></li>
  ...
  <div class="page-content"><!--page-->
   <div class="row"><!--row-->    
    <div class="col-md-7"><!-- bagian tulisan-->            
     <h4 class="popover-title"><strong><span>KOMISI DAN BIAYA</span></strong></h4>
<p>Order transaksi yang dibuat dalam platform mungkin dikenakan biaya dan jumlahnya mungkin berbeda di seluruh platform dan tipe akun. Sebuah transaksi dapat mengandung satu atau semua hal berikut:</p>
<div style="text-align: justify;">
     <ul style="list-style-type: circle;">;
     <li><strong>Komisi.</strong> Biaya komisi mungkin dikenakan pada saat pelaksanaan perdagangan dan jumlah biaya komisi akan tergantung pada jenis akun.</li>
     <li><strong>Swap.</strong> Biaya Swap dapat dibebankan ke posisi terbuka Anda ketika posisi tidak tertutup sampai hari berikutnya. </li>
     <li><strong>Rollover Kontrak.</strong> 3-hari Biaya swap biasanya diterapkan pada hari Rabu untuk menutupi biaya rollover selama akhir pekan</li>

</ul>
<p>Biaya komisi umumnya tetap, tetapi biaya Swap mungkin berbeda dari waktu ke waktu.</p>
     </div>	
