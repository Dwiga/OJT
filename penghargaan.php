     ...
     <li>
       <a  class="active" href="index.php">Beranda</a>
    	<ul class="dropdown">
    	 ...
    	 <li><a class="active" href="penghargaan.php">Penghargaan Broker</a></li>
        </ul>
     </li>
    <li>
  ...
  <div class="page-content"><!--page-->
   <div class="row"><!--row-->    
    <div class="col-md-12"><!-- bagian tulisan-->            
     <h4 class="popover-title"><strong><span>Penghargaan Broker</span></strong></h4>
     <p>
     <?php
		$baris=0;
		foreach($penghargaan as $kolom)
		{
	?>
              <div id="<?php echo $baris ?>">
              <a><strong><?php echo $kolom->judul ?></strong></a>
              <p><?php echo $kolom->penghargaan ?></p>
              </div>
    <?php
		$baris++;
		}
