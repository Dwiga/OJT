    ...
    <li>
	  <a class="active">Download Metatrader</a>
    	<ul class="dropdown">
    	 ...
    	 <li><a class="active" href="android.php">Android</a></li>
  ...
  <div class="page-content"><!--page-->
   <div class="row"><!--row-->    
    <div class="col-md-7"><!-- bagian tulisan-->            
     <h4 class="popover-title"><strong><span>MT4 Android </span></strong></h4>
     <p style="width: 100px; margin: 0px auto;"><a class="button" href="<?php echo $link->android ?>" target="_blank">Download</a></p>
     	<p><?php echo $ketlink->android ?></p> 
