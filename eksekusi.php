   ...
   <div class="navbar-collapse collapse">
    ...
    <li>
      <a class="active">Kebijakan Trading</a>
    	<ul class="dropdown">
		 <li><a class="active" href="eksekusi.php">Kebijakan Eksekusi Trading</a></li>
  ...
  <div class="page-content"><!--page-->
   <div class="row"><!--row-->    
    <div class="col-md-7"><!-- bagian tulisan-->            
     <h4 class="popover-title"><strong><span>Kebijakan Eksekusi Trading</span></strong></h4>
     <p>Millennium Penata Futures menyediakan 3 jenis eksekusi di semua platform:</p>
						<!-- Accordion -->
								...
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordion" href="#collapse-4">
											...
											<i class="fa fa-desktop"></i> Instant execution
										</a>
									</h4>
								</div>
								<!-- Toggle Content -->
								<div id="collapse-4" class="panel-collapse collapse in">
									<div class="panel-body">Eksekusi instan berlaku untuk produk yang paling ditawarkan pada platform. Eksekusi ini terjadi ketika klien ingin segera membeli atau menjual instrumen yang mendasari. Kami berusaha untuk memberikan harga terbaik untuk semua klien, tetapi dalam hal perubahan harga kutipan, eksekusi instan akan memberikan Requote baru untuk klien dengan sepasang baru harga. Klien akan perlu memutuskan apakah setuju dengan harga baru yang ditawarkan.</div>
								</div>
							</div>
							<!-- End Accordion 3 -->
								...
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordion" href="#collapse-5" class="collapsed">
											<i class="fa fa-angle-up control-icon"></i>
											<i class="fa fa-desktop"></i> Market execution
										</a>
									</h4>
								</div>
								<!-- Toggle Content -->
								<div id="collapse-5" class="panel-collapse collapse">
									<div class="panel-body">Eksekusi Market berlaku untuk beberapa produk yang ditawarkan pada platform. Eksekusi ini terjadi ketika klien ingin segera membeli atau menjual instrumen yang mendasari. Kami berusaha untuk memberikan harga terbaik untuk semua klien, tetapi dalam hal perubahan quote harga, pelaksanaan pasar akan mengisi permintaan klien untuk membeli atau menjual produk pada harga berikutnya yang tersedia tanpa konfirmasi terlebih dahulu. Harga dieksekusi pada eksekusi pasar mungkin berbeda dari klien harga yang diminta.</div>
								</div>
							</div>
							<!-- End Accordion 3 -->
								...
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordion" href="#collapse-6" class="collapsed">
											<i class="fa fa-angle-up control-icon"></i>
											<i class="fa fa-desktop"></i> Pending execution
										</a>
									</h4>
								</div>
								<!-- Toggle Content -->
								<div id="collapse-6" class="panel-collapse collapse">
									<div class="panel-body">Eksekusi tertunda berlaku untuk semua produk yang ditawarkan pada platform. Eksekusi ini terdiri dari 6 tingkat yang berbeda:
<ul style="list-style-type: square; text-align: justify;">
<li>Buy limit, eksekusi pending di mana klien ingin masuk posisi buy sekali quote harga mencapai lebih rendah dari harga pasar saat ini</li>
<li>Sell limit, eksekusi pending di mana klien ingin memasukkan posisi sell sekali quote harga mencapai lebih tinggi dari harga pasar saat ini</li>
<li>Buy Stop, eksekusi pending di mana klien ingin masuk posisi buy sekali quote harga mencapai lebih tinggi dari harga pasar saat ini</li>
<li>Sell Stop, eksekusi pending di mana klien ingin memasukkan posisi sell sekali quote harga mencapai lebih rendah dari harga pasar saat ini</li>
<li>Take Profit, eksekusi pending di mana klien ingin menutup perdagangan ketika profit telah mencapai harga tertentu (lebih tinggi dari harga pembukaan untuk buy, lebih rendah dari harga pembukaan untuk sell)</li>
<li>Stop loss, eksekusi pending di mana klien ingin menutup perdatangan ketika kerugian telah mencapai harga tertentu (lebih rendah dari harga pembukaan untuk buy, lebih tinggi dari harga pembukaan untuk sell)</li>
</ul>                                   
