...
<head>
    ...
    <!-- Basic -->
    <title>Victory Matos | Home</title>
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <ul class="contact-details">
                                <li><a href="#"><i class="fa fa-map-marker"></i> JL. Veteran no. 2 ,Malang Town Square</a>
                                </li>
                                <li><a href="#"><i class="fa fa-envelope-o"></i> www.redforex.com</a>
                                </li>
                                <li><a href="#"><i class="fa fa-phone"></i> 0341 - 559151</a>
                                </li>
                            </ul>
                            <!-- End Contact Info -->
                        </div><!-- .col-md-6 -->
